...
@EnableEurekaClient
@EnableZuulProxy
public class GtwHatccApp {

    private static final Logger log = LoggerFactory.getLogger(GtwHatccApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes GtwHatcc.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GtwHatccApp.class);
