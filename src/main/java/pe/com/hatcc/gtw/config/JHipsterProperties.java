...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "GtwHatcc@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "GtwHatcc API";

        private String description = "GtwHatcc API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "GtwHatcc";
